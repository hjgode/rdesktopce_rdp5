...
typedef struct
{
   ...
   UINT32   iDataType;
   DWORD hDevice;
   UINT32	iSymbologyDetail;     //for using STCIdentifier
...
HRESULT ITCSCAN_GetBarcodeConfiguration2 (TCHAR *apScannerConnection, TCHAR *apCfgStr, TCHAR *apCfgValue, INT32 aMaxLen, TCHAR *apLocalPath);
HRESULT ITCSCAN_SetBarcodeConfiguration (TCHAR *apScannerConnection, TCHAR *apCfgStr);
HRESULT ITCSCAN_SetBarcodeConfiguration2 (TCHAR *apScannerConnection, TCHAR *apCfgStr, TCHAR *apLocalPath);
HRESULT ITCSCAN_SetBarcodeConfigurationFromFile (TCHAR *apCfgStr);
HRESULT ITCSCAN_SetBarcodeConfigurationFromFile2 (TCHAR *apCfgStr, TCHAR *apLocalPath);
